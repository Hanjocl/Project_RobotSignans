...
image = cv2.imread('testImage_1.jpg', cv2.IMREAD_GRAYSCALE)                 #TODO -> Add captured image here!
if image is None:
...
P0 = np.array([200, -150, -1500])                                           #TODO -> Input point of canvas here.
P1 = np.array([200, 150, -1500])
P2 = np.array([20, 150, -1900])
P3 = np.array([20, -150, -1900])
